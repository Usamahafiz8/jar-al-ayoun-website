        ...
        >
          <span>
            ...
            >
              ...
              <path d="M11.8601 10.3746C12.2467 10.3746 12.5601 10.0612 12.5601 9.6746C12.5601 9.28801 12.2467 8.97461 11.8601 8.97461C11.4736 8.97461 11.1602 9.28801 11.1602 9.6746C11.1602 10.0612 11.4736 10.3746 11.8601 10.3746Z" />
              <path d="M9.1414 10.3746C9.52799 10.3746 9.84139 10.0612 9.84139 9.6746C9.84139 9.28801 9.52799 8.97461 9.1414 8.97461C8.7548 8.97461 8.44141 9.28801 8.44141 9.6746C8.44141 10.0612 8.7548 10.3746 9.1414 10.3746Z" />
              <path d="M6.34062 10.3746C6.72721 10.3746 7.04061 10.0612 7.04061 9.6746C7.04061 9.28801 6.72721 8.97461 6.34062 8.97461C5.95402 8.97461 5.64062 9.28801 5.64062 9.6746C5.64062 10.0612 5.95402 10.3746 6.34062 10.3746Z" />
              <path d="M20.2998 11.0116C20.1141 11.0116 19.9361 10.9378 19.8048 10.8066C19.6735 10.6753 19.5998 10.4972 19.5998 10.3116V3.22068C19.598 2.87409 19.4595 2.54221 19.2144 2.29712C18.9693 2.05204 18.6374 1.91354 18.2908 1.9117H4.19999C4.01434 1.9117 3.8363 1.83795 3.70502 1.70668C3.57375 1.5754 3.5 1.39736 3.5 1.21171C3.5 1.02606 3.57375 0.848015 3.70502 0.716741C3.8363 0.585468 4.01434 0.511719 4.19999 0.511719H18.2908C19.0087 0.513567 19.6967 0.799568 20.2043 1.3072C20.7119 1.81483 20.9979 2.50279 20.9998 3.22068V10.3116C20.9998 10.4972 20.926 10.6753 20.7948 10.8066C20.6635 10.9378 20.4854 11.0116 20.2998 11.0116Z" />
            </svg>
          </span>
          ...
          >
                      ...
                      >
                        <div className={`w-[44px] h-[44px]  relative `}>
                          ...
                          {item.unread_message > 0 && (
                            <div className="w-[15px] h-[15px] inline-block flex justify-center items-center rounded-full primary-bg text-qblack absolute right-0 top-0 text-xs">
                              <span>
            ...
            <div className={`md:w-[336px] w-full relative`}>
              ...
              <div>
                ...
                >
                  {product &&
                    parseInt(product.vendor_id) === sellerVendorId && (
                      <div
                        ...
                        {sellerMessages.map((item, i) => (
                          <>
                            {item.send_by === "seller" ? (
                              ...
                              <div key={i} className="mb-2 ml-10">
                                <div>
                                  {/*product*/}
                                  {item.product && (
                                    <div
