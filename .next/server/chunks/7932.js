...
/* harmony import */ var _data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(7022);
...
/* harmony import */ var _Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(6681);
...
function SignupWidget({ redirect =true , signupActionPopup , changeContent  }) {
    ...
    const { 0: fname , 1: setFname  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const { 0: lname , 1: setLname  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const { 0: email , 1: setEmail  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("");
    const { 0: phone , 1: setPhone  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("+880");
    ...
    const { 0: checked , 1: setCheck  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
    ...
    const { 0: getCountries , 1: setGetCountries  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(null);
    const { 0: countryDropToggle , 1: setCountryDropToggle  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(false);
    const { 0: selectedCountry , 1: setSelectedCountry  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)("BD");
    const { 0: googleUrl , 1: setGoogleUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(null);
    const { 0: faceBookUrl , 1: setFaceBookUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(null);
    const { 0: twitterUrl , 1: setTwitterUrl  } = (0,react__WEBPACK_IMPORTED_MODULE_5__.useState)(null);
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(()=>{
        if (!getCountries) {
            setGetCountries(_data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_8__ && _data_CountryCodes_json__WEBPACK_IMPORTED_MODULE_8__.countries);
        }
    }, [
        getCountries
    ]);
    ...
    const doSignup = async ()=>{
        setLoading(true);
        await _utils_apiRequest__WEBPACK_IMPORTED_MODULE_7__/* ["default"].signup */ .Z.signup({
            name: fname + " " + lname,
            email: email,
            password: password,
            ...
            setLoading(false);
            react_toastify__WEBPACK_IMPORTED_MODULE_6__.toast.success(res.data.notification);
            if (redirect) {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_5__.useEffect)(()=>{
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${"https://jaralayoun.com/srv/"}api/login/google`).then((res)=>{
            if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${"https://jaralayoun.com/srv/"}api/login/facebook`).then((res)=>{
            if (res.data) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_1___default().get(`${"https://jaralayoun.com/srv/"}api/login/twitter`).then((res)=>{
            console.log(res);
            if (res.data) {
    ...
    return /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                        ...
                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Create_Account
                    }),
            ...
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        className: "flex sm:flex-row flex-col space-y-5 sm:space-y-0 sm:space-x-5 rtl:space-x-reverse mb-5",
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                className: "h-full",
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                        placeholder: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Name,
                                        label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.First_Name + "*",
                                        name: "fname",
                                        type: "text",
                                        inputClasses: "h-[50px]",
                                        value: fname,
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                        placeholder: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Name,
                                        label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Last_Name + "*",
                                        name: "lname",
                                        type: "text",
                                        inputClasses: "h-[50px]",
                                        value: lname,
                    ...
                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        ...
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                placeholder: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Email,
                                label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Email_Address + "*",
                                name: "email",
                                type: "email",
                                inputClasses: "h-[50px]",
                                value: email,
                    ...
                    phone_number_required === "1" && /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                        className: "input-item mb-5 relative",
                        children: [
                            /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                placeholder: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Phone_Number,
                                label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.phone + "*",
                                name: "phone",
                                type: "text",
                        ...
                        children: [
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                        placeholder: "* * * * * *",
                                        label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Password + "*",
                                        name: "password",
                                        type: "password",
                                        inputClasses: "h-[50px]",
                                        value: password,
                            ...
                            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .Z, {
                                        placeholder: "* * * * * *",
                                        label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Confirm_Password + "*",
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            ...
                            children: [
                                ...
                                redirect ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                                    href: "/seller-terms-condition",
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        className: "text-base text-black cursor-pointer",
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.I_agree_all_terms_and_condition_in_ecoShop
                                    })
                                }) : /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
                                    type: "button",
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                    ...
                    googleUrl && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("a", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                    className: "text-[18px] text-qgraytwo font-normal",
                                    children: "Sign Up with Google"
                                })
                            ]
                        })
                    }),
                    faceBookUrl && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("a", {
                            href: `${faceBookUrl}`,
                    ...
                    twitterUrl && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("a", {
                            href: `${twitterUrl}`,
                    ...
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("p", {
                            ...
                            children: [
                                (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Already_have_an_Account,
                                "?",
                                redirect ? /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx((next_link__WEBPACK_IMPORTED_MODULE_3___default()), {
                                    href: "/login",
                                    children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        className: "ml-2 text-qblack cursor-pointer ml-1",
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .Z)()?.Log_In
                                    })
                                }) : /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("button", {
        ...
        children: [
            /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("h1", {
                        className: "text-[34px] font-bold leading-[74px] text-qblack",
                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)()?.Verify_You
                    }),
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        className: "shape -mt-6",
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("svg", {
                ...
                children: [
                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_Helpers_InputCom__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z, {
                            placeholder: "* * * * * *",
                            label: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)()?.OTP,
                            name: "otp",
                            type: "text",
                            inputClasses: "h-[50px]",
                            value: otp,
                        ...
                        children: /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            ...
                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("button", {
                                ...
                                children: [
                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        className: "text-sm text-white block",
                                        children: (0,_Helpers_ServeLangItem__WEBPACK_IMPORTED_MODULE_7__/* ["default"] */ .Z)()?.Verify
                                    }),
                                    loading && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("span", {
                                        className: "w-5 ",
                                        style: {
